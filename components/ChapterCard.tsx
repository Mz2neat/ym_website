    ...
    return(
      ...
      >
        ...
        <div className="flex justify-center mb-4 relative z-15">
            <Link href="/contact">
            <button className="border-2 border-[#2683EB] bg-[#000010] text-white rounded-2xl text-lg md:text-xl lg:text-2xl mt-6 lg:mt-10 font-medium px-6 lg:px-8 py-3 lg:py-4 hover:bg-[#2683EB] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(38,131,235,0.8)]">
              Contact
            </button>
            </Link>
          </div>
