...
export default function halaqahs(){
  return (
    <main className="min-h-screen relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#0B0F14] via-[#0B0F14]/70 to-transparent z-10">
        </div>
      ...
      <div className="grid grid-cols-2 gap-8 mx-auto w-[75%] max-w-8xl relative z-20 sm:mb-4 md:mb-8 lg:mb-16 mt-4 md:mt-8 lg:mt-16">
        
        {/* Retreat Section */}
        <motion.div 
        className="overflow-hidden transform-gpu will-change-transform bg-[#0B0F14]/50 backdrop-blur-md border-[3px] border-[#2683EB] h-100 self-start p-8 lg:p-12 rounded-2xl flex flex-col"
      ...
      >
        ...
        {/* Sports Section */}
        <motion.div 
          className="overflow-hidden transform-gpu will-change-transform bg-[#0B0F14]/50 backdrop-blur-md border-[3px] border-[#2683EB] h-100 rounded-2xl flex flex-col"
          initial={{opacity: 0, y:50}} 
          whileInView={{opacity: 1, y:0}} 
          transition={{duration:0.8}} 
          viewport={{once:true}}
        > 
          ...
          <Image className="object-cover object-[center_30%]" src="/images/Halaqah4.jpeg" fill alt="Sports"></Image>
          </div>
        </motion.div>
